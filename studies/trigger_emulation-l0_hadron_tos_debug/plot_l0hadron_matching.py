...
def plotTM(var, minx=99, maxx=0):
    ntp = '../../ntuples/0.9.4-trigger_emulation/Dst_D0-mc/Dst_D0--21_04_21--mc--MC_2016_Beam6500GeV-2016-MagDown-Nu1.6-25ns-Pythia8_Sim09j_Trig0x6139160F_Reco16_Turbo03a_Filtered_11574021_D0TAUNU.SAFESTRIPTRIG.DST.root'
    ...
    if maxx < minx: xrange = ' '
    bins = '--bins 50 '
    if 'L0Calo_HCAL_region' in var: bins = '--bins 3 '
    ...
    if 'pi_' in var: plotCmd = plotCmd.replace('k_', 'pi_')
    run_cmd(plotCmd)
