...
declare -A NTPS=(
    ...
    ["rdx-run2-Bd2Dst0MuNu-sim09k.root"]="../../ntuples/0.9.6-2016_production/Dst_D0-mc-tracker_only/Dst_D0--22_02_24--mc--tracker_only--MC_2016_Beam6500GeV-2016-MagDown-TrackerOnly-Nu1.6-25ns-Pythia8_Sim09k_Reco16_Filtered_12773410_D0TAUNU.SAFESTRIPTRIG.DST/Dst_D0--22_02_24--mc--tracker_only--MC_2016_Beam6500GeV-2016-MagDown-TrackerOnly-Nu1.6-25ns-Pythia8_Sim09k_Reco16_Filtered_12773410_D0TAUNU.SAFESTRIPTRIG.DST--000-dv.root"
    # ["rdx-run2-Bd2DststMuNu_D0_cocktail-sim09k.root"]="../../ntuples/0.9.6-2016_production/Dst_D0-mc-tracker_only/Dst_D0--22_02_25--mc--tracker_only--MC_2016_Beam6500GeV-2016-MagDown-TrackerOnly-Nu1.6-25ns-Pythia8_Sim09k_Reco16_Filtered_11874430_D0TAUNU.SAFESTRIPTRIG.DST/Dst_D0--22_02_25--mc--tracker_only--MC_2016_Beam6500GeV-2016-MagDown-TrackerOnly-Nu1.6-25ns-Pythia8_Sim09k_Reco16_Filtered_11874430_D0TAUNU.SAFESTRIPTRIG.DST--000-dv.root"
)

for key in "${!NTPS[@]}"; do
    ${PROG} $key ${NTPS[$key]} -c ./vertex_sample.yml
done
