...
CUTFLOW = {
    ...
    'run2-Dst-bare': [
        ...
        Rule('''flag_sel_d0_run2(k_PIDK, pi_PIDK, k_isMuon, pi_isMuon,
                                 k_PT, pi_PT, k_P, pi_P,
                                 k_Hlt1TrackMVALooseDecision_TOS,
                                 pi_Hlt1TrackMVALooseDecision_TOS,
                                 k_IPCHI2_OWNPV, pi_IPCHI2_OWNPV,
                                 k_TRACK_GhostProb, pi_TRACK_GhostProb,
                                 d0_PT, true,
        ...
        Rule('''flag_sel_mu_run1(mu_PX, mu_PY, mu_PZ,
                                 ...
                                 mu_P, mu_IPCHI2_OWNPV, mu_TRACK_GhostProb)''',
             key=r'$\mu$'),
        Rule('''flag_sel_b0dst_run2(spi_TRACK_GhostProb,
                                    dst_ENDVERTEX_CHI2, dst_ENDVERTEX_NDOF,
                                    dst_M, d0_M,
                                    b0_ENDVERTEX_CHI2, b0_ENDVERTEX_NDOF,
                                    b0_ENDVERTEX_X, b0_ENDVERTEX_Y,
...
flag_sel_d0_run2_raw = vectorize(ROOT.FLAG_SEL_D0_RUN2)
...
flag_sel_b0dst_run2_raw = vectorize(ROOT.FLAG_SEL_B0DST_RUN2)
...
def flag_sel_d0_run2(k_pid_k, pi_pid_k, k_is_mu, pi_is_mu,
                     k_pt, pi_pt,
                     k_p, pi_p,
                     k_hlt1_tos, pi_hlt1_tos,
                     k_ip_chi2, pi_ip_chi2,
    ...
    d0_pid_ok = flag_sel_d0_pid_ok_run1(k_pid_k, pi_pid_k, k_is_mu,
                                             pi_is_mu)
    return flag_sel_d0_run2_raw(d0_pid_ok, k_pt, pi_pt, k_p, pi_p,
                                k_hlt1_tos, pi_hlt1_tos,
                                k_ip_chi2, pi_ip_chi2, k_gh_prob, pi_gh_prob,
                                d0_pt, d0_hlt2,
                                d0_endvtx_chi2, d0_endvtx_ndof,
...
def flag_sel_b0dst_run2(spi_gh_prob,
                        dst_endvtx_chi2, dst_endvtx_ndof,
                        dst_m, d0_m,
                        b0_endvtx_chi2, b0_endvtx_ndof,
                        b0_endvtx_x, b0_endvtx_y,
    ...
    return flag_sel_b0dst_run2_raw(fake_sel_d0, fake_sel_mu,
                                   spi_gh_prob,
                                   dst_endvtx_chi2, dst_endvtx_ndof,
                                   dst_m, d0_m,
                                   b0_endvtx_chi2, b0_endvtx_ndof,
...
KNOWN_FUNC['flag_sel_d0_run2'] = flag_sel_d0_run2
KNOWN_FUNC['flag_sel_mu_run1'] = flag_sel_mu_run1
KNOWN_FUNC['flag_sel_b0dst_run1'] = flag_sel_b0dst_run1
KNOWN_FUNC['flag_sel_b0dst_run2'] = flag_sel_b0dst_run2
