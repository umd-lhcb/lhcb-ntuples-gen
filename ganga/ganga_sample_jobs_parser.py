...
LFN_PATH = {
    ...
    'run2-rdx-mc-2017-sim09': '/MC/2017/Beam6500GeV-2017-Mag{polarity}-Nu1.6-25ns-Pythia8/{simcond}/Trig0x62661709/Reco17/Turbo04a-WithTurcal/Stripping29r2Filtered/{decay}/D0TAUNU.SAFESTRIPTRIG.DST',
    'run2-rdx-mc-2018-sim09': '/MC/2018/Beam6500GeV-2018-Mag{polarity}-Nu1.6-25ns-Pythia8/{simcond}/Trig0x617d18a4/Reco18/Turbo05-WithTurcal/Stripping34Filtered/{decay}/D0TAUNU.SAFESTRIPTRIG.DST',
    ...
    'run2-JpsiK-mc-2017-sim09': '/MC/2017/Beam6500GeV-2017-Mag{polarity}-Nu1.6-25ns-Pythia8/{simcond}/Trig0x62661709/Reco17/Turbo04a-WithTurcal/Stripping29r2NoPrescalingFlagged/12143001/ALLSTREAMS.DST',
    'run2-JpsiK-mc-2018-sim09': '/MC/2018/Beam6500GeV-2018-Mag{polarity}-Nu1.6-25ns-Pythia8/{simcond}/Trig0x617d18a4/Reco18/Turbo05-WithTurcal/Stripping34NoPrescalingFlagged/12143001/ALLSTREAMS.DST',
    ...
    # run 2 RDX Bd -> D*+ X (Alex's MC request) for misid (additional signal events)
    'run2-rdx-mc-2016-sim10-bd_dstx': '/MC/2016/Beam6500GeV-2016-Mag{polarity}-Nu1.6-25ns-Pythia8/{simcond}/Trig0x6139160F/Reco16/Turbo03a/Stripping28r2NoPrescalingFlagged/{decay}/ALLSTREAMS.DST',
    'run2-rdx-mc-2017-sim10-bd_dstx': '/MC/2017/Beam6500GeV-2017-Mag{polarity}-Nu1.6-25ns-Pythia8/{simcond}/Trig0x62661709/Reco17/Turbo04a-WithTurcal/Stripping29r2NoPrescalingFlagged/{decay}/ALLSTREAMS.DST',
    ...
    # run 2 RDX minimum bias (30000000) and b-inclusive minimum bias (10000000)
    'run2-rdx-mc-2016-sim10-mb': '/MC/2016/Beam6500GeV-2016-Mag{polarity}-Nu1.6-25ns-Pythia8/{simcond}/Trig0x6139160F/Reco16/Turbo03a/{decay}/DST',
    'run2-rdx-mc-2017-sim10-mb': '/MC/2017/Beam6500GeV-2017-Mag{polarity}-Nu1.6-25ns-Pythia8/{simcond}/Trig0x62661709/Reco17/Turbo04a-WithTurcal/{decay}/DST',
    'run2-rdx-mc-2018-sim10-mb': '/MC/2018/Beam6500GeV-2018-Mag{polarity}-Nu1.6-25ns-Pythia8/{simcond}/Trig0x617d18a4/Reco18/Turbo05-WithTurcal/{decay}/DST',
    ...
    # run 2 RDX noBias
    'run2-rdx-nobias-2016': '/LHCb/Collision16/Beam6500GeV-VeloClosed-Mag{polarity}/Real Data/Reco16/96000000/FULL.DST',
    'run2-rdx-nobias-2017': '/LHCb/Collision17/Beam6500GeV-VeloClosed-Mag{polarity}/Real Data/Reco17/96000000/FULL.DST',
    'run2-rdx-nobias-2018': '/LHCb/Collision18/Beam6500GeV-VeloClosed-Mag{polarity}/Real Data/Reco18/96000000/FULL.DST'
}
