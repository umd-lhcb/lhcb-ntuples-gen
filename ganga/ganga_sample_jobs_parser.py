...
LFN_PATH = {
    ...
    'run2-rdx-mc-2016-sim10-missDDX': '/MC/2016/Beam6500GeV-2016-Mag{polarity}-TrackerOnly-Nu1.6-25ns-Pythia8/{simcond}/Reco16/CustomFiltered/11895400/D0TAUNU.SAFESTRIPTRIG.DST'
}
