...
#define infile2 \
  "ntuples/BCandsData_MD_2012.root"
...
int histo_compare_mmiss() {
  ...
  TFile *uid = new TFile("ntuples/unique_id_YCands.root");
  TFile *did = new TFile("ntuples/duplicate_id_YCands.root");
  ...
  */
  ...
  TFile *match_phoebe = new TFile("BCands_MD_2012_match_phoebe.root");
  ...
  TFile *uid2 = new TFile("ntuples/unique_id_YCands.root");

  //compare Manuel and Phoebe's branches, output saved in histogram
  compare_branch(uid2, match_phoebe, "FitVar_Mmiss2", "m_nu1");
  ...
  TFile *uid3 = new TFile("ntuples/unique_id_YCands.root");
  TFile *match_phoebe3 = new TFile("BCands_MD_2012_match_phoebe.root");
  compare_branch(uid3, match_phoebe3, "FitVar_q2", "q2");

  TFile *uid4 = new TFile("ntuples/unique_id_YCands.root");
  TFile *match_phoebe4 = new TFile("BCands_MD_2012_match_phoebe.root");
  compare_branch(uid4, match_phoebe4, "FitVar_El", "El");
...
void compare_branch(TFile *file1, TFile *file2, const char *branch_name1
  ...
  TBranch *testb1 = t1->GetBranch(branch_name1);
  TBranch *testb2 = t2->GetBranch(branch_name2);
  ...
  if (!testb1 || !testb2) {
    ...
    cout << "Try running the program again stating diffrent branch names." 
    << endl;
    ...
    cout << "The given branches are actual branches in their respective files." << endl;
    ...
    t1->SetBranchAddress(branch_name1,&branch1);
    t2->SetBranchAddress(branch_name2,&branch2);
    ...
    char title[100];
    strcpy(title,branch_name1);
    strcat(title,title2);

    //define the file name to have histogram saved to
    char file_name[100];
    strcpy(file_name,branch_name1);
    ...
    char title_norm[100];
    strcpy(title_norm,branch_name1);
    strcat(title_norm,title3);

    //define file name of 2nd histogram
    char file_norm[100];
    strcpy(file_norm,branch_name1);
