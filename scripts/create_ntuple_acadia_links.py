...
def create_acadia_links(ntuples, storage): # acadia_links will be a folder inside ntuples with same directory structure as ntuples
    ...
    storage_ntuples = {} # dict from annex keys to abs path of file in acadia lhcb-ntuples-gen annex/objects
...
if socket.gethostname() == 'physldren267322': # acadia
    annex_path_acadia = '/home/git/repositories/lhcb-ntuples-gen.git/annex/objects'
